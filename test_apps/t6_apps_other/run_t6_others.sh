...
TA_LIST=(
face1d41-2636-11e1-ad9e0002a5d6c51b
edcf9395-3518-9067-614cafae2909775b
b46325e6-5c90-8252-2eada8e32e5180d6
9ef77781-7bd5-4e39-965f20f6f211f46b
)
...
for ta in "${TA_LIST[@]}"; do
  ...
  "$RUN_INIT_FUNCS" "t6_apps_other/$ta_path" "${COMMON_OPTS[@]}" --hooks "t6_apps_other/$init_file" --cfg-path "$cfg_path"
done
