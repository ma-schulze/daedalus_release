...
TAS_DIR="../../test_binaries/taemu/trustedcore/tas"
BBS_DIR="../../test_binaries/taemu/trustedcore/tas/bbs"
INIT_DIR="."
...
for init_file in "$INIT_DIR"/init_*.py; do
  ...
  "$RUN_INIT_FUNCS" "tc_apps/$ta_path" "${COMMON_OPTS[@]}" --hooks "tc_apps/$init_file" --cfg-path "$cfg_path"
done
